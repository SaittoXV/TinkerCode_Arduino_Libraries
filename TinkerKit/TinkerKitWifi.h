...
class QTRSensors
{
  public:
    ...
    void jebatFinderW(int inByte, int inNext, int lajur, int lajul, float turn, int speedturn, float kp, float kd, int sensorc, int lajak, int dturn);
    void jebatFinderB(int inByte, int inNext, int lajur, int lajul, float turn, int speedturn, float kp, float kd, int sensorc, int lajak, int dturn);
	void jebatDtracer(int lajur, int lajul, int speedturn, float kp, float kd, int sensorc, int linef, int dtracer); 
	void jebatflineB(int lajur, int lajul, int sensorc, int linef); 
	void jebatflineW(int lajur, int lajul, int sensorc, int linef); 
	void jebattillJunction(int lajul, int lajur, int speedturn, int sensorc, int inByte, float kp, float kd,int linef,int basespeed,int forwarddelay);
    void jebattillJunctionSimple(int laju,  int inByte, float kp, float kd, int linef);
    void jebatFinderBlack(int inByte, int inNext, int laju, int turnspeed,float kp, float kd , int lajak,int turndelay); // (type of junction, next robot action, robot speed, turn speed percentage)
	void jebatFinderWhite(int inByte, int inNext, int laju, int turnspeed,float kp, float kd, int terus,int turndelay); // (type of junction, next robot action, robot speed, turn speed percentage)
...
class jebatmini : public QTRSensors
{
  public:
