...
void motorsteer(char *robotdirection, int power)
{
  ...
  {
    digitalWrite(dir1, HIGH);	analogWrite(PWM1, power);
    digitalWrite(dir2, LOW);	analogWrite(PWM2, power);
  }
  
  else if (robotdirection == "backward")
  {
    digitalWrite(dir1, LOW);	analogWrite(PWM1, power);
    digitalWrite(dir2, HIGH); 	analogWrite(PWM2, power);
  }

  else if (robotdirection == "right")
  {
    digitalWrite(dir1, HIGH);	analogWrite(PWM1, power);
    digitalWrite(dir2, LOW);	analogWrite(PWM2, power/3);
  }
  ...
  {
    digitalWrite(dir1, HIGH);	analogWrite(PWM1, power/3);
    digitalWrite(dir2, LOW);	analogWrite(PWM2, power);
  }
