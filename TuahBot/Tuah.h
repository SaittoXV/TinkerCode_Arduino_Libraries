...
class QTRSensors
{
  public:
	...
	void tuahtillJunction(int lajul, int lajur, int speedturn, int sensorc, int inByte, float kp, float kd,int linef,int basespeed);
