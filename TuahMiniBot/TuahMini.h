...
class QTRSensors
{
  public:
    ...
    void tuahFinderW(int inByte, int inNext, int lajur, int lajul, float turn, int speedturn, float kp, float kd, int sensorc, int lajak, int dturn);
    void tuahFinderB(int inByte, int inNext, int lajur, int lajul, float turn, int speedturn, float kp, float kd, int sensorc, int lajak, int dturn);
	void tuahDtracer(int lajur, int lajul, int speedturn, float kp, float kd, int sensorc, int linef, int dtracer); 
	void tuahflineB(int lajur, int lajul, int sensorc, int linef); 
	void tuahflineW(int lajur, int lajul, int sensorc, int linef); 
	void tuahtillJunction(int lajul, int lajur, int speedturn, int sensorc, int inByte, float kp, float kd,int linef,int basespeed,int forwarddelay);
    void tuahtillJunctionSimple(int laju,  int inByte, float kp, float kd, int linef);
    void tuahFinderBlack(int inByte, int inNext, int laju, int turnspeed,float kp, float kd , int lajak,int turndelay); // (type of junction, next robot action, robot speed, turn speed percentage)
	void tuahFinderWhite(int inByte, int inNext, int laju, int turnspeed,float kp, float kd, int terus,int turndelay); // (type of junction, next robot action, robot speed, turn speed percentage)
...
class tuahmini : public QTRSensors
{
  public:
